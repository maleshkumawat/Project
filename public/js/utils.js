(function() {
    ...
    function k(a, b) { a = a.split("."); var c = aa;
    ...
    var n = Array.prototype.indexOf ? function(a, b, c) { return Array.prototype.indexOf.call(a, b, c) } : function(a, b, c) { c = null == c ? 0 : 0 > c ? Math.max(0, a.length + c) : c; if ("string" === typeof a) return "string" !== typeof b || 1 != b.length ? -1 : a.indexOf(b, c); for (; c < a.length; c++)
            if (c in a && a[c] === b) return c;
        return -1 };

    function p(a, b) { a.sort(b || ba) }
    ...
    function na(a) { a = ca(a.a);
        p(a, function(b, c) { return b.a - c.a }); return a };

    function q() { this.a = {};
        this.g = this.f().a;
        this.c = this.h = null }
    q.prototype.has = function(a) { return null != this.a[a.a] };
    q.prototype.get = function(a, b) { return r(this, a.a, b) };
    q.prototype.set = function(a, b) { t(this, a.a, b) };
    q.prototype.add = function(a, b) { u(this, a.a, b) };

    function v(a, b) { for (var c = na(a.f()), d = 0; d < c.length; d++) { var e = c[d],
                f = e.a; if (null != b.a[f]) { a.c && delete a.c[e.a]; var g = 11 == e.c || 10 == e.c; if (e.h) { e = w(b, f); for (var h = 0; h < e.length; h++) u(a, f, g ? e[h].clone() : e[h]) } else e = x(b, f), g ? (g = x(a, f)) ? v(g, e) : t(a, f, e.clone()) : t(a, f, e) } } }
    q.prototype.clone = function() { var a = new this.constructor;
        a != this && (a.a = {}, a.c && (a.c = {}), v(a, this)); return a };
    ...
    function r(a, b, c) { var d = x(a, b); return a.g[b].h ? d[c || 0] : d }

    function y(a, b) { if (null != a.a[b]) a = r(a, b, void 0);
    ...
    function t(a, b, c) { a.a[b] = c;
        a.c && (a.c[b] = c) }

    function u(a, b, c) { a.a[b] || (a.a[b] = []);
        a.a[b].push(c);
        a.c && delete a.c[b] }
    ...
    C.prototype.c = function(a, b) { if (11 == a.c || 10 == a.c) return b instanceof q ? b : this.a(a.m.prototype.f(), b); if (14 == a.c) return "string" === typeof b && oa.test(b) && (a = Number(b), 0 < a) ? a : b; if (!a.l) return b;
        a = a.m; if (a === String) { if ("number" === typeof b) return String(b) } else if (a === Number && "string" === typeof b && ("Infinity" === b || "-Infinity" === b || "NaN" === b || oa.test(b))) return Number(b); return b };
    var oa = /^-?[0-9]+$/;
    ...
    /*
       ...
       */
    function G() { q.call(this) }
    m(G, q);
    var pa = null;

    function H() { q.call(this) }
    m(H, q);
    var qa = null;

    function I() { q.call(this) }
    m(I, q);
    var ra = null;
    G.prototype.f = function() { var a = pa;
    ...
    G.f = G.prototype.f;
    H.prototype.f = function() { var a = qa;
        a || (qa = a = B(H, { 0: { name: "PhoneNumberDesc", j: "i18n.phonenumbers.PhoneNumberDesc" }, 2: { name: "national_number_pattern", b: 9, type: String }, 9: { name: "possible_length", i: !0, b: 5, type: Number }, 10: { name: "possible_length_local_only", i: !0, b: 5, type: Number }, 6: { name: "example_number", b: 9, type: String } })); return a };
    H.f = H.prototype.f;
    ...
    function Ga(a) { var b = a.search(za);
        0 <= b ? (a = a.substring(b), a = a.replace(Ba, ""), b = a.search(Aa), 0 <= b && (a = a.substring(0, b))) : a = ""; return a }

    function Ha(a) { return 2 > a.length ? !1 : O(Ea, a) }

    function Ia(a) { return O(Ca, a) ? P(a, xa) : P(a, wa) }

    function Ja(a) { var b = Ia(a.toString());
        a.c = "";
        a.a(b) }

    function Ka(a) { return null != a && (1 != A(a, 9) || -1 != w(a, 9)[0]) }
    ...
    function La(a, b, c) {
        if (0 == r(b, 2) && null != b.a[5]) { var d = y(b, 5); if (0 < d.length) return d }
        d = y(b, 1);
        var e = R(b);
        ...
        a: { a = 0 == w(a, 20).length || 2 == c ? w(a, 19) : w(a, 20); for (var f, g = a.length, h = 0; h < g; ++h) { f = a[h]; var l = A(f, 3); if (0 == l || 0 == e.search(r(f, 3, l - 1)))
                    if (l = new RegExp(r(f, 1)), O(l, e)) { a = f; break a } }
            a = null }
    ...
    function R(a) { if (null == a.a[2]) return ""; var b = "" + r(a, 2); return null != a.a[4] && r(a, 4) && 0 < y(a, 8) ? Array(y(a, 8) + 1).join("0") + b : b }

    function Ma(a, b, c, d) { switch (b) {
            case 0:
                return "+" + a + c + d;
            case 1:
                return "+" + a + " " + c + d;
    ...
    function W(a, b) { return X(a, r(b, 1)) ? X(a, r(b, 5)) ? 4 : X(a, r(b, 4)) ? 3 : X(a, r(b, 6)) ? 5 : X(a, r(b, 8)) ? 6 : X(a, r(b, 7)) ? 7 : X(a, r(b, 21)) ? 8 : X(a, r(b, 25)) ? 9 : X(a, r(b, 28)) ? 10 : X(a, r(b, 2)) ? r(b, 18) || X(a, r(b, 3)) ? 2 : 0 : !r(b, 18) && X(a, r(b, 3)) ? 1 : -1 : -1 }

    function U(a, b) { if (null == b) return null;
        b = b.toUpperCase(); var c = a.a[b]; if (null == c) { c = va[b]; if (null == c) return null;
            c = (new E).a(I.f(), c);
            a.a[b] = c } return c }

    function X(a, b) { var c = a.length; return 0 < A(b, 9) && -1 == n(w(b, 9), c) ? !1 : O(y(b, 2), a) }

    function Na(a, b) { if (null == b) return null; var c = y(b, 1);
        c = K[c]; if (null == c) a = null;
        else if (1 == c.length) a = c[0];
        else a: { b = R(b); for (var d, e = c.length, f = 0; f < e; f++) { d = c[f]; var g = U(a, d); if (null != g.a[23]) { if (0 == b.search(r(g, 23))) { a = d; break a } } else if (-1 != W(b, g)) { a = d; break a } }
            a = null }
        return a }
    ...
    function Y(a, b, c, d) { var e = V(c, d),
        ...
        if (-1 == f[0]) return 5;
        b = b.length; if (-1 < n(e, b)) return 4;
        c = f[0]; return c == b ? 0 : c > b ? 2 : f[f.length - 1] < b ? 3 : -1 < n(f, b, 1) ? 0 : 5 }

    function Oa(a, b) { var c = R(b);
    ...
    function Pa(a, b, c, d, e, f) {
        ...
        if (0 == h.length) g = 20;
            ...
            Ja(b);
            g = b.toString(); if (0 == g.search(h)) { h = g.match(h)[0].length; var l = g.substring(h).match(ya);
                l && null != l[1] && 0 < l[1].length && "0" == P(l[1], wa) ? g = !1 : (b.c = "", b.a(g.substring(h)), g = !0) } else g = !1;
            g = g ? 5 : 20 }
        e && t(f, 6, g);
        if (20 != g) {
    ...
    function Qa(a, b, c) { var d = a.toString(),
            e = d.length,
            f = r(b, 15); if (0 != e && null != f && 0 != f.length) { var g = new RegExp("^(?:" + f + ")"); if (e = g.exec(d)) { f = new RegExp(y(r(b, 1), 2)); var h = O(f, d),
                    l = e.length - 1;
                b = r(b, 16); if (null == b || 0 == b.length || null == e[l] || 0 == e[l].length) { if (!h || O(f, d.substring(e[0].length))) null != c && 0 < l && null != e[l] && c.a(e[1]), a.set(d.substring(e[0].length)) } else if (d = d.replace(g, b), !h || O(f, d)) null != c && 0 < l && c.a(e[1]), a.set(d) } } }
    ...
    function Ra(a, b, c, d) {
        ...
        if (0 <= f) { var g = f + 15; if ("+" == b.charAt(g)) { var h = b.indexOf(";", g);
            ...
            g = b.indexOf("tel:");
            e.a(b.substring(0 <= g ? g + 4 : 0, f)) } else e.a(Ga(b));
        f = e.toString();
        g = f.indexOf(";isub=");
        ...
        f = new J;
        d && t(f, 5, b);
        a: { b = e.toString();g = b.search(Da); if (0 <= g && Ha(b.substring(0, g))) { h = b.match(Da); for (var l = h.length, z = 1; z < l; ++z)
        ...
        if (1 < d.length && "0" == d.charAt(0)) { t(f, 4, !0); for (a = 1; a < d.length - 1 && "0" == d.charAt(a);) a++;
            1 != a && t(f, 8, a) }
        t(f, 2, parseInt(d, 10));
        return f
    }
    ...
    k("intlTelInputUtils", {});
    k("intlTelInputUtils.formatNumber", function(a, b, c) { try { var d = M.a(),
                e = Z(d, a, b),
                f = Oa(d, e); return 0 == f || 4 == f ? La(d, e, "undefined" == typeof c ? 0 : c) : a } catch (g) { return a } });
    k("intlTelInputUtils.getExampleNumber", function(a, b, c) { try { var d = M.a();
            a: { if (Q(a)) { var e = V(U(d, a), c); try { if (null != e.a[6]) { var f = r(e, 6); var g = Ra(d, f, a, !1); break a } } catch (h) {} }
                g = null }
            return La(d, g, b ? 2 : 1) } catch (h) { return "" } });
    k("intlTelInputUtils.getExtension", function(a, b) { try { return r(Z(M.a(), a, b), 3) } catch (c) { return "" } });
    k("intlTelInputUtils.getNumberType", function(a, b) { try { var c = M.a(); var d = Z(c, a, b),
                e = Na(c, d),
                f = S(c, y(d, 1), e); if (null == f) var g = -1;
            else { var h = R(d);
                g = W(h, f) } return g } catch (l) { return -99 } });
    k("intlTelInputUtils.getValidationError", function(a, b) { try { var c = M.a(),
    ...
    k("intlTelInputUtils.isValidNumber", function(a, b) { try { var c = M.a(),
                ...
                ua = -1 != W(Sa, g) } return ua } catch (Ta) { return !1 } });
