...
<head>
    ...
    <title>{{Auth::user()->name}}-Profile_Page</title>
    <!-- Favicon -->
    ...
    <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header  align-items-center">
                <a class="navbar-brand" href="javascript:void(0)" style="font-size: 30px; font-weight:bolder;">
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('Passenger/profile') }}">
              ...
              <span aria-hidden="true">×</span>
                    ...
                    <img alt="Image placeholder" src="../assets/img/theme/team-5.jpg">
                            ...
                            <div class="dropdown-menu  dropdown-menu-right ">
                                ...
                                <a href="{{ url('Passenger/profile') }}" class="dropdown-item">
                    ...
                    <div class="card card-profile">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="text-center">
                                <h5 class="h3">
                                    {{Auth::user()->name}}<br><span class="font-weight-light">{{Auth::user()->email}}</span>
                                </h5>
                                <div class="h5 mt-4">
                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data" action="">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="input-username" class="form-control" placeholder="name" value="{{ Auth::user()->name }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="input-email" name="email" class="form-control" placeholder="" value="{{ Auth::user()->email }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input-first-name" name="phone" class="form-control" placeholder="phone" value="{{ Auth::user()->phone }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="input-address" class="form-control" name="address" value="{{ Auth::user()->address }}" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input-city" class="form-control" name="city" value="{{ Auth::user()->city }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                ...
                                <div class="pl-lg-4">
                                   ...
                                   <span>
                                       <a href="{{ route('Passenger.profile.edit', Auth::user()->id) }}" class="btn btn-info">edit</a>
                                   </span>
                                </div>
                            </form>
                        </div>
